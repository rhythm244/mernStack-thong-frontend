...
const EditUserForm = ({ user }) => {
  ...
  const onActiveChangeHandler = () => setActive((prev) => !prev);

  const onSaveUserClickHandler = async () => {
    if (password) {
  ...
  const onDeleteUserClickHandler = async () => {
  ...
  const validPasswordClass = password && !validPassword ? "from__input--incomplete" : "";
        ...
        <div className="form__title-row">
          ...
          <div className="form__action-buttons">
            <button
              ...
              title="Save"
              onClick={onSaveUserClickHandler}
              disabled={!canSave}
            >
            ...
            <button
              className="icon-button"
              title="Delete"
              onClick={onDeleteUserClickHandler}
            >
